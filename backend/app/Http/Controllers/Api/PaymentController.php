...
class PaymentController extends Controller
{
    ...
    public function submitManualPayment(Request $request)
    {
        ...
        // SEC-007 FIX: Store receipts in private storage, not public
        ...
        return \Illuminate\Support\Facades\DB::transaction(function () use ($tenant, $plan, $request, $path) {
            ...
            $payment = Payment::create([
                ...
                'amount' => $plan->price, // SEC-005: Use DB price
                'currency' => 'EGP',
    ...
    /**
     * SEC-007: عرض الإيصال بشكل آمن (للأدمن فقط)
     */
    public function viewReceipt($id)
    {
        ...
        // استخدام disk local لضمان عدم وصول أي شخص للصورة عبر رابط مباشر
