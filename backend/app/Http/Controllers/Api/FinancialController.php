...
class FinancialController extends Controller
{
    ...
    {
        $tenantId = $request->user()->tenant_id;
        $commissions = \App\Models\StaffCommission::where('tenant_id', $tenantId)
    ...
    public function updateCommissionStatus(Request $request, $id)
    {
        ...
        $commission = \App\Models\StaffCommission::where('tenant_id', $request->user()->tenant_id)->findOrFail($id);
