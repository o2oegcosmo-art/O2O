              ...
              <>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', marginBottom: '0.5rem' }}>الاسم بالكامل</label>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div>
                        <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', marginBottom: '0.5rem' }}>إسم الصالون / الشركة</label>
                        <input required type="text" style={inputStyle} value={formData.business_name}
                            onChange={e => setFormData({ ...formData, business_name: e.target.value })} />
                    </div>
                    <div>
                        <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', marginBottom: '0.5rem' }}>نوع النشاط</label>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    ...
                    <div>
                        <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', marginBottom: '0.5rem' }}>البريد الإلكتروني</label>
                  ...
                  <button type="submit" disabled={status === 'loading'} className="btn-primary"
                    ...
                    {status === 'loading' ? 'جاري إرسال الطلب...' : 'إرسال طلب التجربة المجانية'}
                    <Send size={18} />
                  </button>
