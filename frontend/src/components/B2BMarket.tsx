            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="relative w-full md:w-auto">
                    ...
                    <input 
                        ...
                        className="bg-white/5 border border-white/10 rounded-full py-3 pr-10 pl-4 text-sm text-white focus:outline-none focus:border-cyan-500/50 w-full md:w-64"
                    />
                </div>
            </div>
